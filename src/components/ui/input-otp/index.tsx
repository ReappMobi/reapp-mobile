      ...
      >
        ...
        {error !== false && (
          <Text
            ...
            testID={`${testID}-error`}
          >
            {typeof error === 'string' ? error : 'Código inválido'}
          </Text>
        )}
        ...
        {showExpiryTimer && expiresIn > 0 && (
          <Text
            ...
            accessibilityLabel={`O código expira em ${timeRemaining} seconds`}
            testID={`${testID}-timer`}
          >
            O código expira em {timeRemaining} segundos
          </Text>
        )}
        ...
        {onResend && (
          ...
          >
            ...
            >
              ...
              >
                {resendCountdown > 0
                  ? `Reenviar código em ${resendCountdown} segundos`
                  : resendAttempts >= maxResendAttempts
